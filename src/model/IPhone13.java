...
public class IPhone13 extends Phone implements Observer, GetHardwareStrategy {
	...
	public void update(Double priceIPhone13Chipset, Double priceIphoneXChipset, Double priceSansungChipset,
		...
		if(price == 0.0)
			setPrice(priceIPhone13Chipset + priceIPhoneRam + priceProScreen + priceIphoneMomory);
	}
}
